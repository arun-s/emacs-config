(defun arun-color-theme-2 ()
  "Color theme by Arun Sivakumaran, based on Wombat for VIM."
  (interactive)
  (color-theme-install
   '(my-color-theme
      ...
      (mouse-color . "yellow"))
     (default
       ((t (:stipple nil :background "#090909" :foreground "red"
     ...
     (font-lock-doc-face ((t (:foreground "#f6f3e8"))))
     (font-lock-function-name-face ((t (:foreground "#e5786d"))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "#f6f3e8"))))
     (font-lock-variable-name-face ((t (:foreground "lightyellow"))))
     (font-lock-warning-face ((t (:bold t :foreground "#e7f6da" :weight bold))))
     ...
     (mouse ((t (:background "#656565"))))
     (region ((t (:background "#cae682"))))
     ;(scroll-bar ((t (nil))))
